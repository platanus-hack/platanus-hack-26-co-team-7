...
2. **[architecture.md](./architecture.md)** — Arquitectura del sistema: componentes, módulos del backend, frontera offline/online, contratos.
3. **[protocol.md](./protocol.md)** — El *telegrama* (schema JSON), máquina de estados del nodo, deduplicación, TTL.
